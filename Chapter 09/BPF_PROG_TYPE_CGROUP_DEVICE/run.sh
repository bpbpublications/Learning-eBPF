...
CGROUP_PATH="/sys/fs/cgroup/test_cgroup"
LOADER="./cgroup_device"
TEST_SCRIPT="./test_program.sh"
BPF_OBJECT="cgroup_device.bpf.o"
...
cleanup() {
    ...
    CGROUP_FD=$(ls /sys/fs/cgroup/test_cgroup/bpf.progs 2>/dev/null)
